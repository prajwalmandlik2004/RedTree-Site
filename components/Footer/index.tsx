      ...
      <footer className="border-t border-stroke bg-white dark:border-strokedark dark:bg-blacksection">
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
              ...
              >
                <a href="/" className="relative">
                  ...
                  <Image
                    width={250}
                    height={120}
                    src="/images/logoredtree_logo.png"
                    alt="Logo"
                    className="hidden dark:block"
                  />
                </a>

                <p className="mb-10 mt-5 ms-12">
                  RedTree Software Site
                </p>
                  ...
                  <form action="#">
                    <div className="relative">
                      <input
                        ...
                        className="w-full rounded-full border border-stroke px-6 py-3 shadow-solid-11 focus:border-red-500 focus:outline-none dark:border-strokedark dark:bg-black dark:shadow-none dark:focus:border-primary"
                      />
                      ...
                      >
                        <svg
                          className="fill-[#757693] hover:fill-red-500 dark:fill-white"
                          width="20"
                          height="20"
                          viewBox="0 0 20 20"
                          fill="none"
          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            ...
            >
              <p>
                &copy; {new Date().getFullYear()} RedTree. All rights reserved
              </p>
            </motion.div>
              ...
              <ul className="flex items-center gap-5">
                <li>
                  <a href="#" aria-label="social icon">
                    <svg
                      className="fill-[#D1D8E0] transition-all duration-300 hover:fill-red-500"
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
                      fill="none"
